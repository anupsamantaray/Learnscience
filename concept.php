				...
				<div class="content-box">
				  <div class="content-box">
								<div class="content-left">
										...
										<h1 class="content_head3">Concept Map</h1>
										<p class="text">
										   The ConceptoGrid<sup>TM</sup> is a versatile tool developed for students to enable them learn easily. It presents the subject as an interconnected flow of ideas that help a student learn things just by looking at ideas & examples in a glance.
										    ConceptoGrid4U<sup>TM</sup> establishes a combination of concepts interlinked in a unique way depending upon the student's learning skill and already acquired knowledge of a particular subject.<br/>
