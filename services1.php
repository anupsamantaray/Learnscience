				...
				<div class="content-box">
				  <div class="content-box">
								<div class="content-left">
										...
										<h1 class="content_head3">Other Services</h1>
										<p class="text" style="line-height:1.6;">
									We would soon be launching our personalised help desk for counselling related to exams.<br /><br />
									</p>
										</div>
										<div class="content-rightbox1" style=" width:94%; display:none; background-color: #104673;">
												<div class="content-rightbox2" style="width:96%;">
														<img src="image/img5.jpg" width="184" style=" border:2px solid #ccc;"/>
