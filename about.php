...
<div id="myModal" class="reveal-modal" style="width:400px;">
		...
		<table style="width:100%; height:250px; font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#333;">
				...
				<tr>
						<td>Contact</td>
						<td>
						<input type="text" name="phone" id="phone" class="form2" onkeyup="return numberonly();"/>
						</td>
				</tr>
				<tr>
						<td>Class</td>
				...
				<div class="content-box">
				  <div class="content-box">
								<div class="content-left">
										...
										<h1 class="content_head3">About us</h1>
									...
									$fet=mysql_query("select * from `about_content` where slno=(select max(slno) from about_content)") or die(mysql_error());
									$res=mysql_fetch_array($fet);
									echo html_entity_decode($res['content']);
									?>
									<br />
									<br />
									<br />
										...
										<div class="content-rightbox1" style=" width:94%; background-color: #104673;">
												<div class="content-rightbox2" style="width:97.5%;">
												   ...
												   { echo html_entity_decode($res['news'])."</br>"; }?>
												   </marquee>
												</div>
										</div>
								</div>
            ...
            <div id="slider" class="nivoSlider">
			 <!--<img src="images/play.jpg" data-thumb="images/nemo.jpg" alt="" height="200" width="200"   />
                ...
                <img src="images/butterfly.jpg" data-thumb="images/walle.jpg" alt="" height="200" width="200" />-->
				 ...
				 <!--<img src="images/about-us.jpg" data-thumb="images/about-us.jpg" alt="" height="200" width="200"   />
                <img src="images/IT team.jpg" data-thumb="images/up.jpg" alt="" height="200" width="200"  />
				 <img src="images/Logical stuff.jpg" data-thumb="images/Logical stuff.jpg" height="200" width="200"  alt="" />
                <img src="images/teacher2.jpg" data-thumb="images/Teachers 1.jpg" alt="" height="200" width="200" />-->
		

		<img src="images/Logical stuff.jpg"/>
		<img src="images/about-us.jpg"/>
		<img src="images/IT team.jpg" />
