			...
			<ul class="product-menu clearfix clear five" id="sti-menu">
				...
				<li>
					<a href="http://preview.ait-themes.com/drivingschool/wp1/price-list-of-courses/">
						...
						<span class="product-icon product-item" data-type="icon">
							<span class="icon-img" style="background: url('images/3.jpg') no-repeat center center"></span>
						</span>
					</a>
				</li>
				<li>
				...
				<div class="content-box">
				  <div class="content-box">
								<div class="content-left">
										...
										<h1 class="content_head3">FAQ</h1>
										<p class="text" style="line-height:1.6;">
								 <span class="bold_head">a) What do we deliver : </span>
								 <br />
								 We deliver educational content which has been designed scientifically by a team of Teachers and experts in psychology. It aims to build conceptual constructs in Students for better understanding.
								 <br />
								 <br />
								 <span class="bold_head">b) How are our products different : </span>
								 <br />
								 ...
								 <br />
								 <br />
								  <span class="bold_head">c) How do students benefit from our products : </span>
								  <br />
								 Students perform much beter in exams even while spending only a small amount of time. Even average students can ace exams by carefully following the learning content.
								 <br />
								 <br />
								  <span class="bold_head">d) How can students & teachers access our products :</span>
								  <br />
								  Our products are currently accessible through our website. Very soon it shall be available on mobile and through our indigenusly developed App - QuicLearn
								 <br />
								 <br />
								 <span class="bold_head">e) What is Chetana Scholarship :</span>
								 <br />
								 It is a scholarship which is sponsored by Gyan Tarang the NGO which supports us in many ways. It aims to encourage positive mindset for studies among students by rewarding meritorius students as well as hardworking students across subjects and geographies. 
								 </p>
										</div>
