				...
				<div id="right_box" style="margin-left:40px;">
						...
						<div id="content1">
								...
								<div id="content2">
										...
										?>
									<form name="f" method="post" action="insert_extra.php" enctype="multipart/form-data">
										...
										<tr>
										<td>Details</td>
										<td><input type="text" name="bookdetails" class="form2"/></td>
										</tr>
										<!--<tr>
										<td>Video</td>
										...
										<tr> 
											...
											<table class="table1" cellpadding="5" style="margin-top:15px;">
												...
												<?php
													...
													$sqlextra=mysql_query("select * from `extra_detail` where `ebook` NOT LIKE ''");
