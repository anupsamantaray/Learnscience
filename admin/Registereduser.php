								...
								<div id="content2">
										...
										?>
											<table class="table1" cellpadding="5" style="margin-top:15px;">
												...
												<?php
												$fetchd=mysql_query("select * from `login` where `status`='0'");
												while($resd=mysql_fetch_array($fetchd))
												{
											         ?>
												<tr>
													<td><a href="student_detail.php?id=<?php echo $resd['slno'];?>"><?php echo $resd['name'];?></a></td>
													...
													<td><a href="Registered_student_edit.php?id=<?php echo $resd['slno'];?>"><img src="image/edit.png"></a></td>
													<!--<td onClick="delete_data(<?php echo $resd['id']; ?>)"><img src="image/delete.png"></td>-->
												</tr>
												<?php
													}
												?>
