...
$ids=$_GET['id'];
$re1=mysql_query("select * from `student_question` where `id`='$ids'");
 		...
 		<div id="main_box">
				...
				<div id="right_box" style="margin-left:40px;">
						...
						<div id="content1">
								...
								<div id="content2">
										<form name="f" method="post" action="question_update.php" enctype="multipart/form-data">
												<table class="table" style="height:150px;">
												<tr>
												   <td>Question Name</td>
													<td>
													<textarea name="question" class="form" style="height:80px; width:350px;"><?php echo $r['questions']; ?></textarea>
													</td> 
