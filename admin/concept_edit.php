 		...
 		<div id="main_box">
				...
				<div id="right_box" style="margin-left:40px;">
						...
						<div id="content1">
								...
								<div id="content2">
										 <form name="f" method="post" action="concept_update.php">
												<table class="table" style="width:100%; height:90px;">
												<?php
													
													$ids=$_GET['id'];
													$res=mysql_query("select * from `tblconcepts` where `id`='$ids'");
													$row=mysql_fetch_array($res);
												?>
												<tr>
												   <td>Concept</td>
													<td><input type="text" name="uname" class="textbox form" value="<?php echo $row['concept']; ?>"></td> 
