						...
						<div id="content1">
								...
								<div id="content2">
										<?php
											  ...
											  ?>
										<form name="f" method="post" id="formid" action="news_action.php" enctype="multipart/form-data">
											...
											<tr>
											    <td>
												<textarea  class="tinymce" name="news" id="question" style="width:50px;"></textarea>
											    </td>
											</tr>
											<tr>
											    <td>Link<input type="text" name="link" id="link" required></td>
											</tr>
											<tr> 
										...
										<table class="table1" cellpadding="5" >
										    ...
										    ?>
										    <tr>
											    <td><?php echo html_entity_decode($res['news']); ?></td>
											    <td><a href="add_newsedit.php?id=<?php echo $res['slno'];?>"><img src="image/edit.png"></a></td>
